...
public class ChartWidget extends javax.swing.JPanel {
	...
	*/
	...
	public ChartWidget(BidimensionalChart chart) {
		...
		try {
			plainTexture = ImageIO.read(new File("src/resources/Terrain2-00.gif"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			hillTexture = ImageIO.read(new File("src/resources/Terrain2-11.gif"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			cityTexture = ImageIO.read(new File("src/resources/FlrTle2-07.gif"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
